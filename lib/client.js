  ...
  factory: (require) => {
    ...
    function SpeedBadge(props) {
      ...
      if (s.phase === 'waiting' || !s.tps) {
        return create('div', {
          style: {
            display: 'flex', justifyContent: 'center', marginTop: SPEED_RAISE,
            padding: '6px 2px', userSelect: 'none', fontSize: 13,
      ...
      return create('div', {
        style: {
          ...
          marginTop: SPEED_RAISE, fontSize: 11, color: 'var(--dsw-alias-label-primary)',
