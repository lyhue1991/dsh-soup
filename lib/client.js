  ...
  factory: (require) => {
    ...
    function SpeedBadge(props) {
      ...
      function renderBadge() {
        ...
        el.style.cssText = 'display:inline-flex;align-items:center;gap:6px;margin-left:10px;font-weight:400;font-size:11px;color:var(--dsw-alias-label-primary);'
        var tok = document.createElement('span')
        tok.style.cssText = 'display:inline-flex;align-items:center;gap:4px;color:var(--dsw-alias-label-caption);'
        ...
        pill.style.cssText = 'margin-left:6px;padding:1px 6px;border-radius:4px;background:' + bg + ';color:#fff;font-size:11px;font-weight:500;'
      ...
      React.useEffect(function () {
        ...
        function attach() {
          ...
          if (target !== null) {
            if (hostRef.current === target) { renderBadge(); return }
