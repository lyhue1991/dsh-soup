...
if (!clientSource.includes('var ICON_UPLOAD')) throw new Error('toolbar upload svg icon missing')
if (!clientSource.includes('var ICON_CLOSE')) throw new Error('toolbar close svg icon missing')
